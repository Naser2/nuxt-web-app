  ...
  <div class="bg-gray-900">
    <div class="">
      <div class="text-center">
        <h2
          class="text-lg bg-gray-700 py-8 leading-6 font-semibold text-gray-300 uppercase tracking-wider"
        >
          Pricing
        </h2>
        <div class="pricing-desc px-4 sm:px-6 lg:px-8">
          <p
            class="mt-8 lg:mt-12 text-3xl leading-9 font-extrabold text-white sm:text-4xl sm:leading-10 lg:text-5xl lg:leading-none"
          >
            The right price for you, whoever you are
          </p>
          <p
            class="mt-3 max-w-4xl mx-auto text-xl leading-7 text-gray-300 sm:mt-5 sm:text-2xl sm:leading-8"
          >
                  ...
                  <div class="bg-white px-6 py-10">
                    <div>
                      ...
                      <div class="mt-4 flex items-center justify-center">
                        <span
                          class="inline-flex justify-center px-4 py-1 rounded-full text-sm leading-5 font-semibold tracking-wide uppercase bg-indigo-100 my-text--blue"
                        >
                          Start
                        </span>
                        <span
                        ...
                        <span
                          class="text-xl leading-7 font-medium text-gray-400"
                        >
                          /hr
                        </span>
                      </div>
                    ...
                    <div class="mt-8">
                      <div class="rounded-lg shadow-md">
                        <a
                          ...
                          class="block w-full text-center rounded-lg border border-transparent bg-white px-6 py-3 text-base leading-6 font-medium my-text--blue hover:text-indigo-500 focus:outline-none focus:shadow-outline transition ease-in-out duration-150"
                        >
                          Contact me
                        </a>
                      </div>
              ...
              <div class="relative z-10 rounded-lg shadow-xl">
                ...
                <div class="absolute inset-x-0 top-0 transform translate-y-px">
                  <div class="flex justify-center transform -translate-y-1/2">
                    <span
                      class="inline-flex rounded-full my-blue px-4 py-1 text-sm leading-5 font-semibold tracking-wider uppercase text-white"
                    >
                      Most popular
                    </span>
                  </div>
                ...
                <div class="bg-white rounded-t-lg px-6 pt-12 pb-10">
                  <div>
                    ...
                    <div class="mt-4 flex items-center justify-center">
                      ...
                      <span
                        class="text-2xl leading-8 font-medium text-gray-400"
                      >
                        /hr
                      </span>
                    </div>
                  ...
                  <div class="mt-10">
                    <div class="rounded-lg shadow-md">
                      <a
                        href="#"
                        data-gumroad-single-product="true"
                        class="block w-full text-center rounded-lg border border-transparent my-blue px-6 py-4 text-xl leading-6 font-medium text-white hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo transition ease-in-out duration-150"
                      >
                        Contact me
                      </a>
                    </div>
