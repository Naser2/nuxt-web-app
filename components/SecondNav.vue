<template>
  <nav :x-data="open" class="the-nav-bar relative shadow fixed w-full z-50 bg-gray-800">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex justify-between h-16">
        <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
          ...
          >
            <svg class="h-6 w-6" stroke="currentColor" fill="bg-white" viewBox="0 0 24 24">
              <path
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:ml-6 sm:flex">
            ...
            >
              <nuxt-link to="/projects" class="rounded py-2 px-3">Projects</nuxt-link>
            </a>
            <a
              href="#"
              class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out"
            ...
            <a
              ...
              class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out"
            >
              <nuxt-link to="/contact" class="rounded py-2 px-3">Contact</nuxt-link>
            </a>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div @click.prevent="open = false" class="ml-3 relative" :x-data="open">
            <div>
              <button
                @click="open = !open"
                class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out"
              >
                <img class="h-12 w-8 rounded-full" src="~assets/images/nas-portrait.jpg" alt />
              </button>
            </div>
            <!-- <div small settings modal
              v-show="open"
