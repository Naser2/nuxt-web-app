<template>
  <div class="footer flex-shrink bg-gray-900 main">
    <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div>
              ...
              <ul class="mt-4">
                <li>
                  <a
                    href="#"
                    class="text-base leading-6 text-blue-300 hover:text-white"
                    >Marketing</a
                  >
                </li>
                <li class="mt-4">
      ...
      >
        <div class="flex md:order-2">
          ...
          <a href="#" class="ml-6 instagram hover:text-blue-300">
          ...
          <a href="#" class="ml-6 text-blue-300 hover:text-blue-300">
          ...
          <a href="#" class="ml-6 text-orange-400 hover:text-blue-300">
          ...
          <a href="#" class="ml-6 text-gray-400 hover:text-blue-300">
        ...
        <p class="mt-8 text-base leading-6 text-gray-400 md:mt-0 md:order-1">
          &copy; 2020 NasCodes, Inc. All rights reserved.
        </p>
      </div>
    </div>
  </div>
