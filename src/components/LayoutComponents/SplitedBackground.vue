 <template>
  <div class="SAMPLE text-gray-800 antialiased">
    <div id="__next">
      <section class="TWO_SIDE_HEADER relative items-center flex lg:h-screen" style="max-height:800px">
        <div class="contain items-center flex flex-wrap">
          <div class="TOP_LEFT_CONTENT w-full md:w-full lg:w-6/12 xl:w-6/12 px-4">
            <div class="sm:pt-0">
              <!-- TOP photo -->
              <!-- <div
                class="FIRST_IMG_WRAPPER w-full md:w-full lg:w-full px-4 md:px-4 mr-auto ml-auto lg:mt-0"
              >
                <div
                  class="relative z-20 flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-600"
                >
                  <img
                    alt="..."
                    src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=700&amp;q=80"
                    class="w-full align-middle rounded-t-lg z-50"
                  />
                </div>
              </div>-->
              <!-- TOP PHOTO END -->
              <div class="z-20 block">
                <ul
                  class="TAGS inline-flex text-gray-700 marketing-blog-post-heading__breadcrumbs"
                  v-for="(tag, idx) in item.tags"
                  :key="idx"
                >
                  <li class="inline-flextext-gray-700" href="/blog">{{tag}}</li>
                  <span class="separator">|</span>
                </ul>
              </div>
              <h2
                class="read-main-title font-semibold text-4xl text-gray-700"
              >A beautiful extension for TailwindCSS.</h2>
              <p class="author mt-4 text-lg leading-relaxed text-gray-600">
                Open Source. It does not change or add any CSS to the already one from
                It features multiple HTML elements and it comes with dynamic components for ReactJS, Vue and Angular.
              </p>
            </div>
          </div>
        </div>
        <!-- src="https://demos.creative-tim.com/tailwindcss-starter-project/_next/static/images/ill_header_3-58248cf88527a12ccfc6cc70ec21d868.png" -->
        <!-- class="BACKGROUND_ART absolute top-0 b-auto right-0 pt-0 sm:w-6/12 -mt-48 sm:mt-0 w-10/12" -->
        <!-- :src="item.coverImage" -->
        <!-- class="BACKGROUND_ART z-10 absolute top-0 b-auto right-0 pt-0 bg-cover bg-center w-full" -->
        <img
          class="hidden BACKGROUND_ART lg:absolute top-0 b-auto right-0 pt-0 sm:w-6/12 -mt-48 sm:mt-0 w-10/12"
          alt="..."
          :src="item.coverImage"
      ...
      <!-- <section class="mt-4 pb-40 relative bg-gray-100 z-20">
        <div
          class="SVG -mt-10 top-0 bottom-auto left-0 right-0 w-full absolute"
            ...
            <div class="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-32">
              ...
              >
                ...
                <blockquote class="relative p-8 mb-4">
                  ...
                  >Putting together a page has never been easier than matching together pre-made components. From landing pages presentation to login areas, you can easily customise and built your pages.</p>
                </blockquote>
              </div>
            </div>
                ...
                <div class="w-full md:w-6/12 px-4">
                  <div class="relative flex flex-col mt-4">
                    <div class="px-4 py-5 flex-auto">
                      ...
                      >Tailwind Starter Kit comes with a huge number of Fully Coded CSS components.</p>
                    </div>
                  </div>
                  <div class="relative flex flex-col min-w-0">
                    <div class="px-4 py-5 flex-auto">
                      ...
                      <p
                        class="mb-4 text-gray-600"
                      >We also feature many dynamic components for React, Vue and Angular.</p>
                    </div>
                  </div>
                </div>
                <div class="w-full md:w-6/12 px-4">
                  <div class="relative flex flex-col min-w-0 mt-4">
                    <div class="px-4 py-5 flex-auto">
                      ...
                      <p
                        class="mb-4 text-gray-600"
                      >This extension also comes with 3 sample pages. They are fully coded so you can start working instantly.</p>
                    </div>
                  </div>
                  <div class="relative flex flex-col min-w-0">
                    <div class="px-4 py-5 flex-auto">
                      ...
                      <p
                        class="mb-4 text-gray-600"
                      >Built by developers for developers. You will love how easy is to to work with Tailwind Starter Kit.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="contain mx-auto overflow-hidden pb-20">
          <div class="flex flex-wrap items-center">
            <div class="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              ...
              >Every element that you need in a product comes built in as a component. All components fit perfectly with each other and can have different colours.</p>
          ...
          <div class="flex flex-wrap items-center pt-32">
              ...
              <div class="justify-center flex flex-wrap relative">
                <div class="my-4 w-full lg:w-6/12 px-4">
                  <div class="bg-blue-500 shadow-lg rounded-lg text-center p-8">
                    ...
                    <p
                      class="text-base text-white opacity-75 mt-2"
                    >A JavaScript library for building user interfaces maintaned by Facebook and community of developers.</p>
                  </div>
                  <div class="bg-green-500 shadow-lg rounded-lg text-center p-8 mt-8">
                    ...
                    <p
                      class="text-base text-white opacity-75 mt-2"
                    >An open-source Model–view–viewmodel JavaScript framework for building user interfaces.</p>
                  </div>
                </div>
                <div class="my-4 w-full lg:w-6/12 px-4 lg:mt-16">
                  <div class="bg-orange-500 shadow-lg rounded-lg text-center p-8">
                    ...
                    <p
                      class="text-base text-white opacity-75 mt-2"
                    >Object-oriented programming language that conforms to the ECMAScript specification.</p>
                  </div>
                  <div class="bg-red-600 shadow-lg rounded-lg text-center p-8 mt-8">
                    ...
                    <p
                      class="text-base text-white opacity-75 mt-2"
                    >a JavaScript-based open-source front-end web framework mainly maintained by Google.</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              ...
              <p
                class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700"
              >In order to create a great User Experience some components require JavaScript. In this way you can manipulate the elements on the page and give more options to your users.</p>
              <p
                class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700"
              >We created a set of Components that are dynamic and come to help you.</p>
              <div class="block pb-6">
                <span
                  class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-gray-600 bg-white uppercase last:mr-0 mr-2 mt-2"
                >Alerts</span>
        ...
        <div class="contain mx-auto px-4 pb-32 pt-48">
          <div class="items-center flex flex-wrap">
            <div class="w-full md:w-5/12 ml-auto px-12 md:px-4">
              <div class="md:pr-12">
                ...
                >This extension comes a lot of fully coded examples that help you get started faster. You can adjust the colors and also the programming language. You can change the text and images and you're good to go.</p>
                <ul class="list-none mt-6">
                  <li class="py-2">
                    <div class="flex items-center">
                      ...
                      <div>
                        <h4 class="text-gray-600">Built by Developers for Developers</h4>
                      </div>
                    </div>
                  </li>
                  <li class="py-2">
                    <div class="flex items-center">
                      ...
                      <div>
                        <h4 class="text-gray-600">Carefully crafted code for Components</h4>
                      </div>
                    </div>
                  </li>
                  <li class="py-2">
                ...
                <div class="w-full lg:w-4/12 px-4">
                  ...
                  >
                    <img
                      ...
                      src="https://demos.creative-tim.com/tailwindcss-starter-project/_next/static/images/login-9c1ecd37bdf6110890b8c8ab6e7bee70.jpg"
                    />
                  </div>
                </div>
                <div class="w-full lg:w-4/12 px-4">
                  ...
                  >
                    <img
                      alt="..."
                      class="align-middle border-none max-w-full h-auto rounded-lg"
                      src="https://demos.creative-tim.com/tailwindcss-starter-project/_next/static/images/profile-c62f8a5b46b0d1826ede094ea1f936fb.jpg"
                    />
                  </div>
                </div>
                <div class="w-full lg:w-4/12 px-4">
                  ...
                  >
                    <img
                      alt="..."
                      class="align-middle border-none max-w-full h-auto rounded-lg"
                      src="https://demos.creative-tim.com/tailwindcss-starter-project/_next/static/images/landing-8150f1b0f50babf23b185788609c24bc.jpg"
                    />
                  </div>
                </div>
              </div>
      ...
      <section class="py-20 bg-gray-700 overflow-hidden">
        <div class="contain mx-auto pb-64">
          <div class="flex flex-wrap justify-center">
            <div class="w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-64">
              ...
              <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-500">
                ...
                <a href="https://tailwindcss.com/" class="text-gray-400" target="_blank">TailwindCSS</a>
              ...
              >Get it free on Github and please help us spread the news with a Star!</p>
              <a
            ...
            <div class="w-full md:w-4/12 px-4 mr-auto ml-auto mt-32 relative">
              <i
                ...
                style="font-size:55em;position:absolute;top:-150px;right:-100%;left:auto;opacity:.8"
              ></i>
            </div>
          </div>
        </div>
        ...
        <div class="contain mx-auto">
          ...
          >
            <div class="w-full text-center lg:w-8/12">
              ...
              <p
                class="text-gray-600 text-lg leading-relaxed mt-4 mb-4"
              >Cause if you do, it can be yours now. Hit the buttons below to navigate to get the Free version for your next project. Build a new web app or give an old project a new look!</p>
              <div class="sm:block flex flex-col mt-10">
                <a
                  class="get-started text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-2 bg-pink-500 active:bg-pink-600 uppercase text-sm shadow hover:shadow-lg"
                  style="transition:all .15s ease"
      ...
      <footer class="relative bg-gray-300 pt-8 pb-6">
        ...
        <div class="HEADER_INFO contain mx-auto px-4">
          <div class="flex flex-wrap">
            <div class="w-full md:w-6/12 px-4">
              ...
              <div class="mt-6">
                <ul class="inline-flex" v-if="item.tags">
                  <li
                    class="flex bg-gray-0. px-3 py-2 mx-2 rounded-full text-gray-900 shadow-lg font-lg items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2 inline-block text-center"
            ...
            <!-- <div class="SOCIAL_MEDIA w-full md:w-6/12 px-4">
...
.marketing-blog-post-heading__breadcrumbs .separator {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
