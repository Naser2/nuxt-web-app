...
<template>
  <div class="gallery-wrapper myblack h-screen mb-12 lg:mb-12">
    <div class="py-16 overflow-hidden lg:py-24">
      <div class="relative max-w-8xl mx-auto px-1 sm:px-6 lg:px-8 ">


        <div class="relative text-center ">
          <h3
            class="text-center title text-2xl leading-8 font-extrabold tracking-tight  sm:text-4xl sm:leading-10" style="color: #FFF59A"
          >Projects</h3>
          <h2
            class="text-center pt-4  text-xl leading-8 font-extrabold tracking-tight  sm:text-2xl sm:leading-10" style="color: #FFF59A"
          >  Some completed projects</h2>
               <!-- <h3 data-v-117b18a6="" class="z-20 mt-10 text-gray-900 font-bold text-4xl text-left lg:mx-20" style="transform: translate(0px, 0px); opacity: 1;"> Some completed projects</h3> -->

        </div>

        <div class="relative mt-10 lg:mt-24 lg:grid lg:grid-cols-3 lg:gap-8 lg:items-center">
          <div
            ...
            :class="
              carouselOpen && index === activeCardId
                ...
                : 'lg:pb-10/12 mb-10 lg:mb-10 bg-white  mx-1 lg:mx-10'
            "
...
<!-- <span class="sm:h4-full sm:w-full h-45 w-45 lg:h-64 lg:w-64 overflow-hidden">
             ...
             />
              ...
              <img
                :class="
                  carouselOpen || hideMainImg ===true
                    ? 'hidden'
                    : ' mt-6 rounded-lg shadow-xl h-72 -px-4 my-20 sm:mt-8 sm:h-72 sm:w-full sm:object-contain sm:object-center lg:hidden font-sans text-sm'
                "
                :src="data.thumbnail"
                alt="Mobileimg"
              />
               ...
               <div class="btns-wrapper opacity-100">
                  ...
                  >
                    <div class="flex" v-show="hideMainImg === false">
                      ...
                      >
                         <button v-show="data.websiteUrl !==''"  type="button" class="inline-flex items-center px-3 py-2 mb-4 rounded-full text-sm font-medium bg-blue-500 text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        > <a :href="data.websiteUrl"
                              class=" w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                            >View website</a/>
                        </button>
      ...
      <div  class=" lg:relative my-4 lg:mt-4 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
         <div  class="relative">
         <h3  class="text-2xl pt-6 text-left font-extrabold text-gray-900 tracking-tight sm:text-3xl pl-8">
             {{ data.title }}
        </h3>
        <p  class="mt-3 text-lg text-gray-500">
          <div class="left-descrip lg:px-2 text-left lg:pl-4">
            <!-- text-blue-400  green-color  Great colors -->
            <div class="top-details">
           <dl class="grid grid-cols-1 gap-x-4 gap-y-2 sm:grid-cols-1 pl-4">
              <div class=" flex inline-flex  sm:col-span-1 -mt-2">
                  ...
                  Technology
                    ...
                    <dd class="flex inline-flex text-sm  mx-2"  v-for="(tk, index) in data.tech" :key="index">
                      ...
                      <span v-show="data.websiteUrl  && data.websiteUrl !=''"
                        class=" pr-4  pt-2 flex inline-flex items-center justify-between text-sm lg:pt-4 ">
                          <!-- <div class="w-0 flex-1 flex items-center"> -->
                            <button

                               type="button"
                              class="iflex-shrink-0 items-center px-3 py-0.5 rounded-full text-sm font-medium rounded-xl text-white bg-green-500 hover:text-orange-500"
                              >
...
<span class="sm:h4-full sm:w-full h-45 w-45 lg:h-64 lg:w-64 overflow-hidden">
                                  <img
                                    :src="data.thumbnail"
                                    class="justify-center px-4 -mt-2 pb-2 lg:px-0
                                    bg-center cursor-pointer h-45 w-45 lg:h-64 lg:w-64"
                                  />   </span>
        <!-- <img  width="490" height="200"
          ...
          <div class="sm:col-span-2 divide-y divide-gray-200 ">
                    ...
                    <dd class="mt-1 text-lg text-gray-900 px-8 py-2 pb-20" v-html="data.previewDescription">
 ...
 <div class="sm:sr-only">
     ...
     <!-- <div class="gallery-wrapper-bottom myblack mb-32 lg:pb-20"></div> -->
  </div>
</template>
